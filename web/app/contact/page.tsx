                        ...
                        <div className="space-y-12">
                            ...
                            <div className="pt-8">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="w-12 h-12 rounded-full bg-primary/40 flex items-center justify-center text-slate-300 hover:text-white hover:bg-accent-orange transition-all border border-white/5">
